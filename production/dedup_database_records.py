...
try:
    ...
    for tag in tqdm(tags):
        target_names.append(clean_data(tag[0]))
    ...
    for x in tqdm(articles):
        X_train.append([clean_data(x[0]), clean_data(x[1]), x[2], clean_data(x[3]), x[4], clean_data(x[5])])
    ...
    for x in tqdm(articles):
        X_train.append([clean_data(x[0]), clean_data(x[1]), x[2], x[3], clean_data(x[5]) ])
